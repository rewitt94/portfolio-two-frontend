      ...
      <div>
        <div className="copyright_box">
          ...
          <div className="photo_comment">
            <p>These Images are taken for <a href="https://unsplash.com/">Unsplash</a>. The website has an amazing library of royalty free photography.</p>
          </div>
          <h2><span>Website Symbols</span></h2>
          <div className="copyright_row">
            <div className="copyright_img">
              <img src="http://www.clker.com/cliparts/E/C/O/z/A/T/swirl-hi.png"
              style={night ? {filter: 'invert(100)'} : {}}
              />
            </div>
            <div className="copyright_description">
              <p>This is a freely available clipart taken from <a href="http://www.clker.com">www.clker.com</a></p>
            </div>
          </div>
          <div className="copyright_row">
            <div className="copyright_img">
              <img src="https://maxcdn.icons8.com/Share/icon/Arrows//right_down21600.png"
              style={night ? {filter: 'invert(100)'} : {}}
              />
            </div>
            <div className="copyright_description">
          ...
          <div className="copyright_row">
            <div className="copyright_img">
              <img src="http://laoblogger.com/images/first-quarter-moon-clipart-1.jpg"
              style={night ? {filter: 'invert(100)'} : {}}
              />
            </div>
            <div className="copyright_description">
              <p>This is a freely available clipart taken from <a href='http://laoblogger.com'>laoblogger.com</a></p>
            </div>
          </div>
          <div className="copyright_row">
            <div className="copyright_img">
              <img src="http://images.clipartpanda.com/home-clip-art-KTnqkGjTq.png"
              style={night ? {filter: 'invert(100)'} : {}}
              />
            </div>
            <div className="copyright_description">
              <p>This is a freely available clipart taken from <a href='http://www.clipartpanda.com/'>www.clipartpanda.com</a></p>
            </div>
          </div>
          <div className="copyright_row">
            <div className="copyright_img">
            ...
            <div className="copyright_description">
              <p>This is a freely available clipart taken from <a href="https://www.wikimedia.org/">www.wikimedia.org</a></p>
            </div>
          </div>
          <h2><span>Submarine Game Clipart</span></h2>
          <div className="copyright_row">
            <div className="copyright_sub_img">
              <img src="https://thecliparts.com/wp-content/uploads/2016/07/submarine-clipart-2.png"/>
            </div>
            <div className="copyright_description">
              <p>This is a freely available clipart (not for commercial use) taken from <a href="https://thecliparts.com/">thecliparts.com</a></p>
            </div>
          </div>
          <div className="copyright_row">
            <div className="copyright_sub_img">
          ...
          <div className="copyright_row">
            ...
            <div className="copyright_description">
              <p>This is a freely available clipart taken from <a href="http://clipartix.com/">clipartix.com</a></p>
            </div>
          </div>
          <div className="copyright_row">
            <div className="copyright_sub_img">
