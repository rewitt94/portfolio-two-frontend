        ...
        <div className="coding_box">
          ...
          <div className="index_row">
            <div className="index_inner_grid">
              <div><div><p>Language</p></div></div>
              <div><div><p>Ability</p></div></div>
            </div>
          ...
          <div className="grid_row">
            <div className="grid_inner_grid">
              <div><div><p>Javascript</p></div></div>
              <div><div><p>Strong</p></div></div>
            </div>
          ...
          <div className="grid_row">
            <div className="grid_inner_grid">
              <div><div><p>Ruby</p></div></div>
              <div><div><p>OK</p></div></div>
            </div>
            <div className="grid_inner_flex">
              <p>Ruby-ruby-ruby</p>
            </div>
          ...
          <div className="grid_row">
            <div className="grid_inner_grid">
              <div><div><p>Python</p></div></div>
              <div><div><p>Weak</p></div></div>
            </div>
            <div className="grid_inner_flex">
              <p>Hello.</p>
            </div>
          ...
          <div className="grid_row">
            <div className="grid_inner_grid">
              <div><div><p>SQL</p></div></div>
              <div><div><p>Very Weak</p></div></div>
            </div>
            <div className="grid_inner_flex">
              <p>Oi.</p>
            </div>
          ...
          <div className="grid_row">
            <div className="grid_inner_grid">
              <div><div><p>GitHub</p></div></div>
              <div><div><p>IMGs</p></div></div>
            </div>
            <div className="grid_inner_flex">
              <p>Yes</p>
            </div>
